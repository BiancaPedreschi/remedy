...
duration = 30 * 60# 20 minuti in secondi
# duration = 3 # 20 minuti in secondi
sample_rate = 48000
pink_noise = generate_pink_noise(duration, volume=.6, sample_rate=sample_rate)

# Salva il file audio
output_file = "/home/phantasos/python_projects/space/remedy/data/PN_48000.wav"
