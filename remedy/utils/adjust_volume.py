...
if __name__ == "__main__":
    ...
    adjust_volume(orig_fname_PN, orig_fname_PP, new_fname_PN, new_fname_PP, volume_PN=.07, volume_PP=.004, fs=44100)
    ...
    dev_hp, dev_sp = find_device()
    sd.default.device = dev_hp
    adjust_volume(orig_fname_PN, orig_fname_PP, new_fname_PN, new_fname_PP, volume_PN=.0, volume_PP=.5, fs=44100)
